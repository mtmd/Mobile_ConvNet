...
public class SqueezeNet {
    ...
    public void seqSqueezeNet (Context context) throws InterruptedException {
        loadParameters("SqueezeNet/Logs", "sequential.txt", "/SqueezeNet/Parameters/Normal", false);
        ...
        convRelu(img, conv1, conv1_w, conv1_b, 227, 227, 3, 96, 7, 2, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_Conv1", "Conv1 (ms): ", false);
        if (debug)
        ...
        maxpool(conv1, pool1, 111, 111, 96, 3, 2, context, "SqueezeNet/Logs", "sequential.txt", "sequential_Pool1", "Pool1 (ms)", false);
        if (debug)
        ...
        convRelu(pool1, fire2_squeeze1x1, fire2_squeeze1x1_w, fire2_squeeze1x1_b, 55, 55, 96, 16, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire2_squeeze1x1", "Fire2_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire2_squeeze1x1, fire2_expand1x1, fire2_expand1x1_w, fire2_expand1x1_b, 55, 55, 16, 64, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire2_expand1x1", "Fire2_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire2_squeeze1x1, fire2_expand3x3, fire2_expand3x3_w, fire2_expand3x3_b, 55, 55, 16, 64, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire2_expand3x3", "Fire2_expand3x3 (ms): ", false);
        if (debug)
        ...
        convRelu(fire2_concat, fire3_squeeze1x1, fire3_squeeze1x1_w, fire3_squeeze1x1_b, 55, 55, 128, 16, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire3_squeeze1x1", "Fire3_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire3_squeeze1x1, fire3_expand1x1, fire3_expand1x1_w, fire3_expand1x1_b, 55, 55, 16, 64, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire3_expand1x1", "Fire3_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire3_squeeze1x1, fire3_expand3x3, fire3_expand3x3_w, fire3_expand3x3_b, 55, 55, 16, 64, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire3_expand3x3", "Fire3_expand3x3 (ms): ", false);
        if (debug)
        ...
        convRelu(fire3_concat, fire4_squeeze1x1, fire4_squeeze1x1_w, fire4_squeeze1x1_b, 55, 55, 128, 32, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire4_squeeze1x1", "Fire4_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire4_squeeze1x1, fire4_expand1x1, fire4_expand1x1_w, fire4_expand1x1_b, 55, 55, 32, 128, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire4_expand1x1", "Fire4_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire4_squeeze1x1, fire4_expand3x3, fire4_expand3x3_w, fire4_expand3x3_b, 55, 55, 32, 128, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire4_expand3x3", "Fire4_expand3x3 (ms): ", false);
        if (debug)
        ...
        maxpool(fire4_concat, pool4, 55, 55, 256, 3, 2, context, "SqueezeNet/Logs", "sequential.txt", "sequential_Pool2", "Pool2 (ms)", false);
        if (debug)
        ...
        convRelu(pool4, fire5_squeeze1x1, fire5_squeeze1x1_w, fire5_squeeze1x1_b, 27, 27, 256, 32, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire5_squeeze1x1", "Fire5_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire5_squeeze1x1, fire5_expand1x1, fire5_expand1x1_w, fire5_expand1x1_b, 27, 27, 32, 128, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire5_expand1x1", "Fire5_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire5_squeeze1x1, fire5_expand3x3, fire5_expand3x3_w, fire5_expand3x3_b, 27, 27, 32, 128, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire5_expand3x3", "Fire5_expand3x3 (ms): ", false);
        if (debug)
        ...
        convRelu(fire5_concat, fire6_squeeze1x1, fire6_squeeze1x1_w, fire6_squeeze1x1_b, 27, 27, 256, 48, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire6_squeeze1x1", "Fire6_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire6_squeeze1x1, fire6_expand1x1, fire6_expand1x1_w, fire6_expand1x1_b, 27, 27, 48, 192, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire6_expand1x1", "Fire6_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire6_squeeze1x1, fire6_expand3x3, fire6_expand3x3_w, fire6_expand3x3_b, 27, 27, 48, 192, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire6_expand3x3", "Fire6_expand3x3 (ms): ", false);
        if (debug)
        ...
        convRelu(fire6_concat, fire7_squeeze1x1, fire7_squeeze1x1_w, fire7_squeeze1x1_b, 27, 27, 384, 48, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire7_squeeze1x1", "Fire7_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire7_squeeze1x1, fire7_expand1x1, fire7_expand1x1_w, fire7_expand1x1_b, 27, 27, 48, 192, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire7_expand1x1", "Fire7_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire7_squeeze1x1, fire7_expand3x3, fire7_expand3x3_w, fire7_expand3x3_b, 27, 27, 48, 192, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire7_expand3x3", "Fire7_expand3x3 (ms): ", false);
        if (debug)
        ...
        convRelu(fire7_concat, fire8_squeeze1x1, fire8_squeeze1x1_w, fire8_squeeze1x1_b, 27, 27, 384, 64, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire8_squeeze1x1", "Fire8_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire8_squeeze1x1, fire8_expand1x1, fire8_expand1x1_w, fire8_expand1x1_b, 27, 27, 64, 256, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire8_expand1x1", "Fire8_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire8_squeeze1x1, fire8_expand3x3, fire8_expand3x3_w, fire8_expand3x3_b, 27, 27, 64, 256, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire8_expand3x3", "Fire8_expand3x3 (ms): ", false);
        if (debug)
        ...
        maxpool(fire8_concat, pool8, 27, 27, 512, 3, 2, context, "SqueezeNet/Logs", "sequential.txt", "sequential_Pool8", "Pool8 (ms)", false);
        if (debug)
        ...
        convRelu(pool8, fire9_squeeze1x1, fire9_squeeze1x1_w, fire9_squeeze1x1_b, 13, 13, 512, 64, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire9_squeeze1x1", "Fire9_squeeze1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire9_squeeze1x1, fire9_expand1x1, fire9_expand1x1_w, fire9_expand1x1_b, 13, 13, 64, 256, 1, 1, 0, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire9_expand1x1", "Fire9_expand1x1 (ms): ", false);
        if (debug)
        ...
        convRelu(fire9_squeeze1x1, fire9_expand3x3, fire9_expand3x3_w, fire9_expand3x3_b, 13, 13, 64, 256, 3, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_fire9_expand3x3", "Fire9_expand3x3 (ms): ", false);
        if (debug)
        ...
        convRelu(fire9_concat, conv10, conv10_w, conv10_b, 13, 13, 512, 1000, 1, 1, 1, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_Conv10", "Conv10 (ms): ", false);
        if (debug)
        ...
        avgpool(conv10, pool10, 15, 15, 1000, 15, 1, context, "SqueezeNet/Logs", "sequential.txt", "sequential_Pool10", "Pool10 (ms)", false);
        if (debug)
        ...
        softmax(pool10, prob, 1000, "SqueezeNet/Logs", "sequential.txt", "Prob (ms)", false);
    ...
    public void parSqueezeNet (Context context) throws InterruptedException {
        ...
        loadParameters("SqueezeNet/Logs", "parallel.txt", "/SqueezeNet/Parameters/Vectorized", false);
        ...
        int[] conv1TypeSet = {1, 4, 6, 8, 12, 24};
        ...
        paraMaxPool(rs, convNet, 55 * 55 * 24, 3, 111, 111, 2, conv1Allocation, pool1Allocation, "SqueezeNet/Logs", "4.txt", "Pool1 (ms): ", false);
        if (debug) {
            float[] pool1 = new float[55 * 55 * 96];
        ...
        int[] fire2_squeeze1x1_TypeSet = {1, 4};
        ...
        int[] fire2_expand_TypeSet = {1, 4, 8, 16};
        ...
        int[] fire3_squeeze1x1_TypeSet = {1, 4};
        ...
        int[] fire3_expand_TypeSet = {1, 4, 8, 16};
        ...
        int[] fire4_squeeze1x1_TypeSet = {1, 4, 8};
        ...
        int[] fire4_expand_TypeSet = {1, 4, 8, 16, 32};
        ...
        paraMaxPool(rs, convNet, 27 * 27 * 64, 3, 55, 55, 2, fire4_expand_Allocation, pool4Allocation, "SqueezeNet/Logs", "4.txt", "Pool4 (ms): ", false);
        if (debug) {
        ...
        int[] fire5_squeeze1x1_TypeSet = {1, 4, 8};
        ...
        int[] fire5_expand_TypeSet = {1, 4, 8, 16, 32};
        ...
        int[] fire6_squeeze1x1_TypeSet = {1, 4, 6, 12};
        ...
        int[] fire6_expand_TypeSet = {1, 4, 6, 8, 12, 16, 24, 48};
        ...
        int[] fire7_squeeze1x1_TypeSet = {1, 4, 6, 12};
        ...
        int[] fire7_expand_TypeSet = {1, 4, 6, 8, 12, 16, 24, 48};
        ...
        int[] fire8_squeeze1x1_TypeSet = {1, 4, 8, 16};
        ...
        int[] fire8_expand_TypeSet = {1, 4, 8, 16, 32, 64};
        ...
        paraMaxPool(rs, convNet, 13 * 13 * 128, 3, 27, 27, 2, fire8_expand_Allocation, pool8Allocation, "SqueezeNet/Logs", "4.txt", "Pool8 (ms): ", false);
        if (debug) {
        ...
        int[] fire9_squeeze1x1_TypeSet = {1, 4, 8, 16};
        ...
        int[] fire9_expand_TypeSet = {1, 4, 8, 16, 32, 64};
        ...
        paraAvgPool(rs, convNet, 250, 15, 15, 15, 1, conv10Allocation, pool10Allocation, "SqueezeNet/Logs", "4.txt", "Pool10 (ms): ", false);
        if (debug) {
        ...
        softmax(prob, prob, 1000, "SqueezeNet/Logs", "parallel.txt", "Prob from parallel (ms)", false);
        if (result)
            binaryDumper("SqueezeNet/Intermediate_rslts/Parallel", "prob.bin", prob, 1000);
        Log.i(tag, "Prob finished.");
    }
    public float SqueezeNetInference (Context context) {
        loadParameters("SqueezeNet/Logs", "5000.txt", "/SqueezeNet/Parameters/Vectorized", false);
